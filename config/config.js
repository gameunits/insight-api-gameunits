...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\Gameunits\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/Gameunits/';
  //if (isLinux) dataDir = process.env.HOME + '/.Gameunits';
  if (isLinux) dataDir = '/home/gameunits/.gameunits';
}
